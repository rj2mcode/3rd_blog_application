...
class $AssetsFontsGen {
  ...
  /// List of all assets
  List<String> get values => [vazirBold, vazirRegular];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/logo.ico
  String get logoIco => 'assets/images/logo.ico';
  ...
  /// File path: assets/images/top-banner.jpg
  AssetGenImage get topBanner =>
      const AssetGenImage('assets/images/top-banner.jpg');

  /// List of all assets
  List<dynamic> get values =>
      [arrowDown, logoIco, logoPng, logo960x960, profile, robotIcon, topBanner];
}
